...
export class Player {
    ...
    updatePrePhysics() {
         ...
         * Hand Tracking
         */
        if (this.game.inputs.mode === Inputs.MODE_HANDTRACKING && this.game.inputs.handTracking?.active) {
            this.accelerating = this.game.inputs.handTracking.accelerating
            this.steering = this.game.inputs.handTracking.steering
            this.boosting = this.game.inputs.handTracking.boosting
            this.braking = this.game.inputs.handTracking.braking
        }
    }
