...
export class Inputs {
    ...
    setHandTracking() {
        ...
        this.handTracking.events.on('enabled', () => {
            this.updateMode(Inputs.MODE_HANDTRACKING)
        })

        this.handTracking.events.on('disabled', () => {
            this.updateMode(Inputs.MODE_MOUSEKEYBOARD)
        })
    }
}